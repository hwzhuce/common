...
{
    public class HeaderFooterHelperBase : PdfPageEventHelper
    {
        #region 属性
        private String _fontFilePathForHeaderFooter = Path.Combine(Path.GetPathRoot(Environment.GetFolderPath(Environment.SpecialFolder.System)), "Windows\\Fonts\\KAIU.TTF");
        /// <summary>
        /// 页眉/页脚所用的字体
        /// </summary>
        ...
        private String _fontFilePathForBody = Path.Combine(Path.GetPathRoot(Environment.GetFolderPath(Environment.SpecialFolder.System)), "Windows\\Fonts\\SIMSUN.TTC,1");
        /// <summary>
        /// 正文内容所用的字体
        /// </summary>
        ...
        private ReportPara _reportPara = new ReportPara();


        public ReportPara ReportPar
        {
